        ...
        <View style={styles.viewContainer}>
          ...
          <View style={settingsStyles.section}>
            ...
            <DropDownPicker
              ...
              placeholderStyle={
                settingsStyles.dropdownPlaceholder
              }
              arrowIconContainerStyle={
                settingsStyles.arrowIconContainer
              }
            />
          </View>
          ...
          {/* Model AI */}
          <View style={settingsStyles.section}>
            <Text style={styles.sectionText}>Model AI</Text>
        ...
        <View style={settingsStyles.modalOverlay}>
          <View style={settingsStyles.modalContainer}>
            ...
            <View style={settingsStyles.modalButtons}>
              ...
              >
                <Text
                  style={settingsStyles.secondaryButtonText}
                >
              ...
              >
                {savingPassword ? (
                  ...
                  <Text
                    style={settingsStyles.primaryButtonText}
                  >
