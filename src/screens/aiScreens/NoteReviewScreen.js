    ...
    <SafeareaNoNav>
      <View style={styles.headerBackground}>
        <Text style={styles.headerText}>
          {getTranslatedText("reviewScreenTitle")}
        </Text>
      </View>
          ...
          {!loading && aiResult ? (
            <View style={{ width: "100%" }}>
              <Text style={styles.headlineText}>
                {getTranslatedText("reviewSummary")}
              </Text>
              ...
              <Text style={styles.headlineText}>
                {getTranslatedText("reviewWorthAdd")}
              </Text>
              <View style={styles.divider} />
              ...
              <Text style={styles.headlineText}>
                {getTranslatedText("reviewUnclear")}
              </Text>
              <View style={styles.divider} />
              <View style={{ marginBottom: 24 }}>
              ...
              >
                {getTranslatedText("reviewRevisedNote")}
              </Text>
              <View
                style={{
              ...
              <MakeButton
                onPress={handleApplyImprovedNote}
              />
            </View>
          ) : null}
        </View>
